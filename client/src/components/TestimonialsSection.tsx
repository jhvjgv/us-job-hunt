...
const testimonials = [
  {
    ...
    color: "bg-blue-500",
    quote:
      "在雅典娜编程的帮助下，我从零开始准备，3 个月内拿到了 Google 的 Offer。导师不仅帮我刷题，还帮我彻底改变了面试思维方式。系统设计那块之前完全不懂，现在可以流畅地讲 1 小时。",
    tags: ["算法特训", "系统设计", "内推"],
  },
  {
    name: "李晓雯",
    ...
    color: "bg-purple-500",
    quote:
      "我之前在一家小公司工作，想跳槽到大厂但不知道从哪里入手。雅典娜编程帮我制定了完整的跳槽计划，从简历到谈判全程陪跑。最终拿到了 Meta Senior 的 Offer，薪资直接翻倍！",
  ...
  },
  {
    ...
    color: "bg-orange-500",
    quote:
      "国内工作 5 年想来美国，英语面试是最大的障碍。雅典娜编程的导师帮我专门训练英语表达，用 STAR 法则重构我的项目经历。面试时感觉非常自信，Amazon 一轮过！",
    tags: ["行为面试", "英语表达", "签证规划"],
  },
  {
    name: "陈思远",
    ...
    color: "bg-teal-500",
    quote:
      "OPT 期间找工作压力很大，时间紧迫。雅典娜编程帮我快速锁定目标公司，高效准备，在 OPT 到期前 2 个月就拿到了 Stripe 的 Offer，省去了很多焦虑。",
    tags: ["OPT 求职", "算法特训", "内推"],
  },
];
